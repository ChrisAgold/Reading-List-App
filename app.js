...
// check if titles is an array, it is false since titles returns an HTML collection
//console.log(Array.isArray(titles));
// This  turns the HTML collection into an array and returns true
//console.log(Array.isArray(Array.from(titles)));

// converts the HTML collection into an array and loops through it
...
// var books = document.querySelector('#book-list li .name'); // .querySelector only selects one
// console.log(books);

// books = document.querySelectorAll('#book-list li .name'); // .querySelectorAll selects all with class of name within li
// console.log(books);
...
//
// Array.from(books).forEach(function(book){
//     book.textContent += ' (book title)'; // adds text to the book list
// });

// Update HTML
// const bookList = document.querySelector('#book-list');
// bookList.innerHTML = '<h2>Books and more books..</h2>'; // replace current HTML with h2 tag
// bookList.innerHTML += '<p>This is how you add HTML</p>'; // append the p tag to h2

//**********************************************************************************************************************//
//const banner = document.querySelector('#page-banner');
// console.log('#page-banner node type is:',banner.nodeType); // find node type: element
// console.log('#page-banner node name is:',banner.nodeName); // find elements name: div
// console.log('#page-banner has child nodes:',banner.hasChildNodes()); // find child nodes: true

// Clone a Node
//const clonedBanner = banner.cloneNode(true); // true gives all nested nodes, false returns just the parent node
